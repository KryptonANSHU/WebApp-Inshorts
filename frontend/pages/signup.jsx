...
const signup = () => {
  ...
  return (
      ...
      <div className='flex flex-col'>
        <div className={'text-2xl h-fit mt-8 '}>SIGN UP WITH EMAIL</div>
        <form className='max-w-md w-full mt-8'>
          ...
          <button
            className="w-full mt-6 text-white text-lg p-3 px-8 border-[1px] border-custom-blue bg-custom-blue/20 hover:bg-custom-blue/40 transition-all rounded-sm flex justify-between"
            onClick={signup}>
            <h1>
              Sign Up
            </h1>
        ...
        <div className='mt-4'>
          <h1>Already have an account? <a className='text-custom-blue' href='/signin'>Sign In</a></h1>
        </div>
      </div>
  );
}
